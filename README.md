...
Wszystkie skrypty w tym repozytorium korzystają z ujednoliconego zestawu parametrów. Dzięki temu projektowanie całych przekładni jest intuicyjne – zębatki o tym samym **module (m)** zawsze będą do siebie pasować, zależnie od typu zębatki.
